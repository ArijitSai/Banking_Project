...
public class Bank_account {
	...
	@Id
	@SequenceGenerator(initialValue=44335534,allocationSize = 1,sequenceName = "accno",name="accno")
...
@OneToMany(cascade = CascadeType.ALL) //it is used to save the data in the database without using begin,persist,commit
