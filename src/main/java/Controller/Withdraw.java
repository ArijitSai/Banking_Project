	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		double amount=Double.parseDouble(amnt);
		 ...
		 if(bank_account.getAmount()<amount)
		 {
			 ...
			 {
				 resp.getWriter().print("<h1>You are exceeding yor account limit, your actual account limit is:"+bank_account.getAcc_limit()+"</h1>"); 
			 }
				 ...
				 BankTransaction bankTransaction=new BankTransaction();
					...
					resp.getWriter().print("<h1>amount has been withdrawn Sucessfully</h1>");
			 }
		 }
